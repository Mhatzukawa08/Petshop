								...
								<td>
									<table border="0" width="100%" class="bg-light" cellpadding="10">
										<tr>
											...
											<td>
												<label class="text-dark"><b>Perawatan</b></label>
											</td>
										</tr>
									</table>
									<hr style="margin-top: 1px; margin-bottom: 5px;">
					...
					<div class="col-lg-12 mt-2">
						<table border="0" width="100%" class="bg-light rounded">
							...
							<tr>
								<td>
									<?php
									$queryDokumentasi = mysqli_query($koneksi, "SELECT * FROM dokumentasi WHERE id_pilihan_pesanan='2' AND id_pesanan='$id_pesanan' ORDER BY waktu ASC ");
