    	...
    	<div class="page container">
    		<div class="row layanan">
    			...
    			<div class="col-lg-12">
					...
					<div class="row">
						<?php 
							$queryPenitipan = mysqli_query($koneksi, "SELECT * FROM pesanan_perawatan WHERE id_user='$id_user' AND ket='0' AND id_pemesanan>0 
					...
					<div class="row">
						<?php 							
							$queryPenitipan = mysqli_query($koneksi, "SELECT * FROM pesanan_vaksin WHERE id_user='$id_user' AND ket='0' ");
							// SELECT * FROM riwayat_pesanan WHERE id_user='$id_user' AND selesai='0' AND id_pemesanan>0 
                            //              GROUP BY id_pemesanan HAVING count(*) > 0 ORDER BY id_pemesanan ASC
							while ($row = mysqli_fetch_assoc($queryPenitipan)) {
								$keterangan = "Belum Ada aksi";
