		...
		<div class="row layanan">
			...
			<div class="col-lg-12">
				<div class="row">
					...
					<?php
					$query = mysqli_query($koneksi, "SELECT * FROM pesanan_produk WHERE id_user='$id_user' AND ket='1' AND selesai='1' AND id_pemesanan>0 
								...
								<tr">
									...
									<tr>
										<td>
											...
											<a href="detail-riwayat-pesanan.php?toko=<?=$id_toko?>&pesanan=<?=$id_pemesanan?>">
