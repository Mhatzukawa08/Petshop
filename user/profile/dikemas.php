  				...
  				<div class="row">
  						...
  						<table border="0" width="100%" class="bg-light rounded">
  								...
  								<td align="center">
  									<table border="0" width="95%" class="bg-light">
  										<tr>
  											...
  											<td align="right">
  												<label class="text-danger mr-2"><b>Dikemas</b></label>
  											</td>
  										</tr>
  							...
  							<tr>
  								<td><hr style="margin-top: 10px; margin-bottom: 1px;">
  									<a href="lihat-produk.php">
  										<table border="0" width="100%" class="">
  											<tr>
  												<td align="center" style="cursor: pointer;">
  													<label class="text-dark" style="cursor: pointer;"><b>Tampilkan Pesanan</b></label>
  												</td>
  											</tr>
  										</table><hr style="margin-top: 1px; margin-bottom: 5px;">
  									</a>
  									...
  									<table border="0" width="100%" class="bg-light">
  										<tr>
  											<td>
  												...
  												<label class="text-success"><b>Sedang dimandikan</b></label>
  											</td>
  										</tr>
  									</table>
  								</td>
  					...
  					<div class="col-lg-4 mt-2">
  						<table border="0" width="100%" class="bg-light rounded">
  							...
  							<tr>
  								<td><hr style="margin-top: 10px; margin-bottom: 1px;">
  									<a href="lihat-layanan.php">
  										<table border="0" width="100%" class="">
  											<tr>
  												<td align="center" style="cursor: pointer;">
  													<label class="text-dark" style="cursor: pointer;"><b>Tampilkan Produk Lengkap</b></label>
  												</td>
  											</tr>
  										</table><hr style="margin-top: 1px; margin-bottom: 5px;">
  									</a>
  								...
  								<td>
  									<table border="0" width="100%" class="bg-light">
  										<tr>
  											<td>
  												<i class="flaticon-grooming-1 text-success ml-2"></i>
  												<label class="text-success"><b>Sedang dikemas</b></label>
  											</td>
  										</tr>
  									</table>
  								</td>
