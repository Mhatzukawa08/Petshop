						...
						<table border="0" width="100%" class="bg-light rounded">
							<tr>
								<td>
									<table border="0" width="100%" class="bg-light">
										<tr>
											<td>
												<a href="../toko/detail-toko.php?toko=<?=$id_toko?>" class="text-dark ml-2" style="margin-left: 10px;"><h5><?= $nama_toko ?></h5></a>
											</td>
										</tr>
									</table>
							...
							<tr>
								<td align="center">
									...
									$id_pemesanan = "";
									$queryPesananProduk = mysqli_query($koneksi, "SELECT * FROM pesanan_produk WHERE id_user='$id_user' AND id_toko='$id_toko' AND ket='0' ");
							...
							<tr>
								<td>
									<hr style="margin-top: 1px; margin-bottom: 5px;">
									<a href="" data-toggle="modal" data-target="#pesanProduk">
										<table border="0" width="100%" class="bg-success rounded">
											<tr class="bg-success rounded">
												<td align="center">
													<label class="text-white" style="cursor: pointer;"><b>Pesan Produk</b></label>
												</td>
											</tr>
										</table>
									</a>
