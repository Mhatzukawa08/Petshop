  			...
  			<div class="col-lg-9 page-with-sidebar">
  				...
  				<form action="">
  					<div class="form-group">
  						...
  						<input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Nama Hewan">
  					</div>
  					<div class="form-group">
  						<label for="exampleFormControlInput1">Jenis Hewan</label>
  					...
  					<div class="form-group">
  						<label for="exampleFormControlInput1">Tgl Penitipan</label>
  						<input type="date" class="form-control" id="exampleFormControlInput1" placeholder="Jumlah Hewan">
  					</div>
  					<div class="form-group">
  						<label for="exampleFormControlInput1">Jumlah Hari</label>
  						<input type="number" class="form-control" id="exampleFormControlInput1" placeholder="Jumlah hari" maxlength="2">
  					</div>
  					<div class="form-group">
  						<label for="exampleFormControlInput1">Makanan</label>
  						<div class="col-lg-4">
  							<input type="radio" name="makanan"> Makanan Sendiri
  						</div> 
  						<div class="col-lg-4">
  							<input type="radio" name="makanan"> Makanan pihak petshop
  						</div> 
  					</div>
  					<!-- <div class="form-group">
  						<label for="exampleFormControlInput1">Jenis Makanan</label>
  						<div class="col-lg-4">
  							<input type="radio" name="m-petshop"> Whiskas
  						</div> 
  						<div class="col-lg-4">
  							<input type="radio" name="m-petshop"> Ikan kering
  						</div> 
  						<div class="col-lg-4">
  							<input type="radio" name="m-petshop"> Ikan kaleng
  						</div> 
  					</div> -->
  					<!-- <div class="form-group">
  			...
  			<div class="sidebar col-lg-3 res-margin bg-light card h-50 pattern3">
  				<div class="widget-area">
  					...
  					<div class="list-group">
  						<a href="layanan.php?url=penitipan" class="list-group-item list-group-item-action active">Penitipan</a>
  						<a href="layanan.php?url=perawatan" class="list-group-item list-group-item-action">Perawatan</a>
