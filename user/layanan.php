    							...
    							<tr>
    								<td>
    									<table border="0" width="100%" class="bg-light" cellpadding="10">
    										<tr>
    											<td width="8">
    												<i class="flaticon-dog-training-3 text-dark h1"></i>
    											</td>
    											<td>
    												<label class="text-dark"><b>Pelatihan</b></label>
    											</td>
    										</tr>
    									</table>
    								</td>
    								...
    								<td><hr style="margin-top: 10px; margin-bottom: 1px;">
    									<a href="lihat-layanan.php">
    										<table border="0" width="100%" class="bg-success">
    											<tr>
    												<td align="center">
    													<label class="text-white"><b>Lihat Progres</b></label>
    												</td>
    											</tr>
    										</table><hr style="margin-top: 1px; margin-bottom: 5px;">
    									</a>
    							...
    							<tr>
    								<td><hr style="margin-top: 10px; margin-bottom: 1px;">
    									<table border="0" width="100%" class="bg-light">
    										<tr>
    											<td align="center">
    												<label class="text-dark"><b>Lihat Progres</b></label>
    											</td>
    										</tr>
    									</table><hr style="margin-top: 1px; margin-bottom: 5px;">
    								</td>
