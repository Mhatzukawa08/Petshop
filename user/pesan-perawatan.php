...
<div class="page">
 <div class="container">
  <div class="row">
   ...
   <div class="form-group">
    <label for="exampleFormControlInput1">Jenis Perawatan</label>
    <div class="col-lg-3">
     <input type="checkbox" name="1"> Potong Kuku
   </div> 
   <div class="col-lg-3">
     <input type="checkbox" name="1"> Potong Kaki
   </div> 
   <div class="col-lg-3">
     <input type="checkbox" name="1"> Memandikan
   </div> 
   <div class="col-lg-3">
     <input type="checkbox" name="1"> Potong Kuku
   </div> 
