...
<head>
         ...
         <div class="bottom-fixed shadow-sm text-dark">
            <table width="100%" border="0" cellpadding="5" class="menu">
               <tr>
                  ...
                  <td align="center" width="20%">
                     <a href="produk.php">
                        <i class="flaticon-food icon_br active1"></i>
                     </a>
                     <p class="ket-menu active1"><b>Produk</b></p>
                  </td>
                  <td align="center" width="20%">
   ...
   <div class="page container">
      <div class="row">
         <!-- page  starts -->
         <div class="col-lg-12">
            <div class="btn-group col-lg-4 col-6 col-md-4 mt-2" role="group" aria-label="Basic example">
               <button type="button" class="btn btn-secondary">All</button>
               <button type="button" class="btn btn-secondary">Items</button>
               <button type="button" class="btn btn-secondary">Acc</button>
            </div>
            <div class="row mt-2">
               <!-- event 1 -->		 
               <div class="col-lg-4 col-6 col-md-4 mt-2">
                  <div class="card-img">
                     ...
                     <a href="event-single.html">
                        <img class="card-img-top img-product" src="https://www.pethouse.co.id/cfind/source/thumb/images/produk/cover_w420_h420_excel%20fish%20new.jpg" alt="">
                     </a>
                  </div>
                  <div class="card-body text-left">
                     ...
                     <ul class="list-unstyled colored-icons">
                        <li><span><i class="flaticon-dog-kennel mr-2"></i>Simpel Aja Store</span></li>
                        <li><span><i class="flaticon-prize-badge-with-paw-print mr-2"></i>Rp. 50.000</span></li>
                     </ul>
                     <!-- button -->   
                  </div>
