...
<div class="page">
 <div class="container">
  <div class="row">
   ...
   <div class="form-group">
    <label for="exampleFormControlInput1">Jumlah Hewan</label>
    <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Jumlah Hewan">
  </div>
  <div class="form-group">
    <label for="exampleFormControlInput1">Hari Kunjungan</label>
    <input type="date" class="form-control" id="exampleFormControlInput1" placeholder="Nama Hewan">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    <label for="exampleFormControlInput1">Jenis Operasi</label>
    <div class="col-lg-3">
     <input type="radio" name="1"> Cesar
   </div> 
   <div class="col-lg-3">
     <input type="radio" name="2"> Amputasi
   </div> 
   <div class="col-lg-3">
     <input type="radio"> Kebiri
   </div> 
 </div>
  					<!-- <div class="form-group">
