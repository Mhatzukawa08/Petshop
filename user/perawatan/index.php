...
<body id="top">
      ...
      <div class="jumbo-heading" data-aos="fade-up">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page">Perawatan</li>
          </ol>
        </nav>
        <!-- /breadcrumb -->
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="sidebar col-lg-3 res-margin bg-light card h-50 pattern3">
          <div class="widget-area">
            ...
            <div class="list-group">
              ...
              <a href="../perawatan/?toko=<?= $id_toko ?>" class="list-group-item list-group-item-action active">Perawatan</a>
        ...
        <div class="col-lg-9 page-with-sidebar">
          ...
          <!-- Image -->
          <form action="perawatan-post.php" method="POST">
            ...
            <div class="col-md-6">
              <button type="submit" class="btn btn-primary mt-3" name="pesan_perawatan" id="pesan_perawatan">Lanjutkan Pesanan</button>
            </div>
          </form>
          <!-- /row -->
        </div>
  ...
  <script>
    function showSelectJenisPerawatan() {
      ...
      var select2 = document.getElementById("jenis_perawatan");
