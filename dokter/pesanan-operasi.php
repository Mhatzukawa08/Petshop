					...
					<div class="col-sm-12">
						<div class="table-container">
							...
							if (isset($_GET['id_pemesanan'])) {
								...
								$jadwal = "";
								if ($dataPesananoperasi['jadwal'] != "") {
									$jadwal = ubahTanggalDanWaktu($dataPesananoperasi['jadwal']);
								};

								$ket_jadwal = $dataPesananoperasi['ket_jadwal'];
												...
												<table border="0" width="100%" class="bg-light">
													<tr>
														<td>
															...
															<button class="btn btn-primary mt-4 mb-4" data-toggle="modal" data-target="#tambahData">Tambah Dokumentasi</button>
															...
															<div class="modal fade" id="tambahData" tabindex="-1" aria-labelledby="tambahDataLabel" aria-hidden="true">
																<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
																	<div class="modal-content">
																		<form action="pesanan-operasi-post.php" method="post" enctype="multipart/form-data">
																			<div class="modal-header">
																				<h5 class="modal-title" id="tambahDataLabel">Tambah Dokumentasi</h5>
																				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
																					<span aria-hidden="true">&times;</span>
																				</button>
																			</div>
