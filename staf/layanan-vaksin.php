						...
						<div class="modal fade" id="tambahData" tabindex="-1" aria-labelledby="tambahDataLabel" aria-hidden="true">
							<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
								<div class="modal-content">
									<form action="layanan-vaksin-post.php" method="post" enctype="multipart/form-data">
										...
										<div class="modal-body">
											...
											<div class="mb-3">
												...
												<select name="jenis_hewan" class="form-control" id="jenis_hewan" required>
													...
													while ($row = mysqli_fetch_assoc($query)) {
														...
														$cekVaksin = mysqli_query($koneksi, "SELECT * FROM `vaksin` WHERE jenis_hewan='$id_jenis_hewan' ");
														$rowVaksin = mysqli_num_rows($cekVaksin);
														if ($rowVaksin == 0) {
													?>
											...
											<div class="mb-3">
												<label for="vaksin_1" class="form-label">Harga vaksin 1</label>
												<input type="number" class="form-control" id="vaksin_1" name="vaksin_1">
											</div>
											<div class="mb-3">
												<label for="vaksin_2" class="form-label">Harga vaksin 2</label>
												<input type="number" class="form-control" id="vaksin_2" name="vaksin_2">
											</div>
											<div class="mb-3">
												<label for="vaksin_3" class="form-label">Harga vaksin 3</label>
												<input type="number" class="form-control" id="vaksin_3" name="vaksin_3">
											</div>
										</div>
										<div class="modal-footer">
											<button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
											<button type="submit" id="tambah_vaksin" name="tambah_vaksin" class="btn btn-primary">Simpan</button>
										</div>
									</form>
								</div>
							</div>
								...
								<table class="table m-0">
									<thead>
										<tr>
											...
											<th scope="col">Harga Vaksin Ke-1</th>
											<th scope="col">Harga Vaksin Ke-2</th>
											<th scope="col">Harga Vaksin Ke-3</th>
											<th scope="col">Settings</th>
										</tr>
									</thead>
									<tbody>
										<?php
										$queryOperasi = mysqli_query($koneksi, "SELECT * FROM vaksin WHERE id_toko='$id_toko' ");

										$no = 1;
										while ($row = mysqli_fetch_assoc($queryOperasi)) {
											$id_vaksin = $row['id_vaksin'];
											$id_jenis_hewan = $row['jenis_hewan'];
											$value_id_jenis_hewan = $row['jenis_hewan'];
											$vaksin_1 = $row['vaksin_1'];
											$vaksin_2 = $row['vaksin_2'];
											$vaksin_3 = $row['vaksin_3'];
										...
										?>
											<tr>
												<th scope="row"><?= $no ?></th>
												<td><?= $jenis_hewan ?></td>
												<td><?= rupiah($vaksin_1) ?></td>
												<td><?= rupiah($vaksin_2) ?></td>
												<td><?= rupiah($vaksin_3) ?></td>

												<td>
													<a href="" class="mr-2" data-toggle="modal" data-target="#editModal<?= $id_vaksin ?>">
														<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
															<path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
															<path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z" />
														</svg>
													</a>
													<a href="" data-toggle="modal" data-target="#hapusModal<?= $id_vaksin ?>">
											...
											<div class="modal fade" id="editModal<?= $id_vaksin ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
												<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
													<div class="modal-content">
														<form action="layanan-vaksin-post.php" method="post" enctype="multipart/form-data">
															<div class="modal-header">
															...
															<div class="modal-body">
																<input type="text" class="form-control" id="id_vaksin" name="id_vaksin" value="<?= $id_vaksin ?>" hidden>
																...
																<div class="mb-3">
																	<label for="vaksin_1" class="form-label">vaksin 1</label>
																	<input type="text" class="form-control" id="vaksin_1" name="vaksin_1" value="<?= $vaksin_1 ?>">
																</div>
																<div class="mb-3">
																	<label for="vaksin_2" class="form-label">vaksin 2</label>
																	<input type="text" class="form-control" id="vaksin_2" name="vaksin_2" value="<?= $vaksin_2 ?>">
																</div>
																<div class="mb-3">
																	<label for="vaksin_3" class="form-label">vaksin 3</label>
																	<input type="text" class="form-control" id="vaksin_3" name="vaksin_3" value="<?= $vaksin_3 ?>">
																</div>
															</div>
															<div class="modal-footer">
																<button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
																<button type="submit" id="edit_vaksin" name="edit_vaksin" class="btn btn-primary">Simpan</button>
															</div>
														</form>
													</div>
												</div>
											...
											<div class="modal fade" id="hapusModal<?= $id_vaksin ?>" tabindex="-1" aria-labelledby="hapusModalLabel" aria-hidden="true">
												<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
													<div class="modal-content">
														<form action="layanan-vaksin-post.php" method="post">
															<div class="modal-header">
															...
															<div class="modal-body">
																<div class="mb-3">
																	<label for="nama_hewan" class="form-label">Menghapus vaksin akan menghapus data yang berhubungan</label>
																	<input type="text" class="form-control" id="id_vaksin" name="id_vaksin" value="<?= $id_vaksin ?>" hidden>
																</div>
															</div>
															<div class="modal-footer">
																<button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
																<button type="submit" id="hapus_vaksin" name="hapus_vaksin" class="btn btn-primary">Simpan</button>
															</div>
														</form>
													</div>
												</div>
