				...
				<ul class="navbar-nav">
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="doctoRs">
							...
							<li>
								<a class="dropdown-item active-page" href="pesanan-perawatan.php">Perawatan</a>
							</li>
							<li>
					...
					<div class="col-sm-12">
						<div class="table-container">
							...
							if (isset($_GET['id_pemesanan'])) {
								...
								$queryPesananperawatan = mysqli_query($koneksi, "SELECT * FROM pesanan_perawatan WHERE id_pemesanan='$id_pemesanan' ");
								$dataPesananperawatan = mysqli_fetch_array($queryPesananperawatan);
								...
								$id_perawatan = $dataPerawatan['id_perawatan'];
								$id_toko = $dataPerawatan['id_toko'];
										...
										<tr>
											<td>
												<table border="0" width="100%" class="bg-light" cellpadding="10">
													<tr>
														<td>
															<h4 class="text-dark"><b>perawatan</b></h4>
														</td>
													</tr>
												</table>
										...
										<tr>
											<td>
												<table border="0" width="100%" class="bg-light">
													<tr>
														<td>
															<label class="text-dark ml-2"><b>Jenis Perawatan</b></label>
														</td>
														<td align="right">
															<label class="text-dark mr-2"><b><?= $jenis_perawatan ?></b></label>
														</td>
													</tr>
												</table>
											</td>
											...
											<td>
												<table border="0" width="100%" class="bg-light">
													<tr>
														...
														<td align="right">
															<label class="text-success mr-2"><b>perawatan - <?= $id_pemesanan ?></b></label>
														</td>
													</tr>
												</table>
												<hr style="margin-top: 1px; margin-bottom: 5px;">
																	...
																	<div class="modal-content">
																		<form action="pesanan-perawatan-post.php" method="post" enctype="multipart/form-data">
																			...
																			<div class="modal-body">
																				...
																				<input type="text" class="form-control" id="id_pesanan_perawatan" name="id_pesanan_perawatan" value="<?= $id_pesanan_perawatan ?>" hidden>
																				<div class="mb-3">
											...
											<td>
												<table class="table m-0">
													...
													<tbody>
														...
														$queryDokumentasiperawatan = mysqli_query($koneksi, "SELECT * FROM `dokumentasi` WHERE id_pilihan_pesanan='2' AND id_pesanan='$id_pesanan_perawatan' ");
														while ($row = mysqli_fetch_assoc($queryDokumentasiperawatan)) {
														...
														?>
															...
															<div class="modal fade" id="hapusModal<?= $id_dokumentasi ?>" tabindex="-1" aria-labelledby="hapusModalLabel" aria-hidden="true">
																<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
																	<div class="modal-content">
																		<form action="pesanan-perawatan-post.php" method="post">
																			<div class="modal-header">
							...
							?>
								<div class="row row-cols-auto">
									...
									while ($hasil = mysqli_fetch_assoc($query)) {
										$id_pesanan_perawatan = $hasil['id_pesanan_perawatan'];
										...
										if ($hasil['bayar'] == "0") {
											echo '
												<div class="col mt-2">
													<a href="pesanan-perawatan.php?id_pemesanan=' . $hasil['id_pemesanan'] . '">
											...
											echo '
												<div class="col mt-2">
													<a href="pesanan-perawatan.php?id_pemesanan=' . $hasil['id_pemesanan'] . '" class"">
														<div class="card border-0 shadow" style="text-align: center;" id="btn-awal">
															<div class="card-body"">
