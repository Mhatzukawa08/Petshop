		...
		<nav class="navbar navbar-expand-lg custom-navbar">
			...
			<div class="collapse navbar-collapse" id="royalHospitalsNavbar">
				<ul class="navbar-nav">
					...
					<li class="nav-item">
						<a class="nav-link active-page" href="jenis-hewan.php">
						...
						<div class="modal fade" id="tambahData" tabindex="-1" aria-labelledby="tambahDataLabel" aria-hidden="true">
							<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
								<div class="modal-content">
									<form action="jenis-hewan-post.php" method="post">
										...
										<div class="modal-footer">
											...
											<button type="submit" id="tambah_jenis_hewan" name="tambah_jenis_hewan" class="btn btn-primary">Simpan</button>
										</div>
									</form>
								</div>
							</div>
							...
							<tbody>
								...
								?>
									<tr>
										...
										<td><?= $jenis_hewan ?></td>
										<td>
											<a href="" class="mr-2" data-toggle="modal" data-target="#exampleModal<?= $id_jenis_hewan ?>">
												<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
													<path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
													<path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z" />
												</svg>
											</a>
											<a href="" data-toggle="modal" data-target="#hapusModal<?= $id_jenis_hewan ?>">
									...
									<div class="modal fade" id="exampleModal<?= $id_jenis_hewan ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
										<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
											<div class="modal-content">
												<form action="jenis-hewan-post.php" method="post">
													<div class="modal-header">
													...
													<div class="modal-body">
														<div class="mb-3">
															<label for="nama_hewan" class="form-label">Nama Hewan</label>
															<input type="text" class="form-control" id="jenis_hewan" name="jenis_hewan" value="<?= $jenis_hewan ?>">
															<input type="text" class="form-control" id="id_jenis_hewan" name="id_jenis_hewan" value="<?= $id_jenis_hewan ?>" hidden>
														</div>
													</div>
													<div class="modal-footer">
														<button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
														<button type="submit" id="edit_jenis_hewan" name="edit_jenis_hewan" class="btn btn-primary">Simpan</button>
													</div>
												</form>
											</div>
										</div>
									...
									<div class="modal fade" id="hapusModal<?= $id_jenis_hewan ?>" tabindex="-1" aria-labelledby="hapusModalLabel" aria-hidden="true">
										<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
											<div class="modal-content">
												<form action="jenis-hewan-post.php" method="post">
													<div class="modal-header">
													...
													<div class="modal-body">
														<div class="mb-3">
															<label for="nama_hewan" class="form-label">Menghapus Jenis Hewan akan menghapus data yang berhubungan</label>
															<input type="text" class="form-control" id="id_jenis_hewan" name="id_jenis_hewan" value="<?= $id_jenis_hewan ?>" hidden>
														</div>
													</div>
													<div class="modal-footer">
														<button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
														<button type="submit" id="hapus_jenis_hewan" name="hapus_jenis_hewan" class="btn btn-primary">Simpan</button>
													</div>
												</form>
											</div>
										</div>
