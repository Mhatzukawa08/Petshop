				...
				<ul class="navbar-nav">
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="doctoRs">
							...
							<li>
								<a class="dropdown-item active-page" href="riwayat-pesanan-operasi.php">Operasi</a>
							</li>
							<li>
						...
						<div class="table-container">
							...
							?>
								<div class="row row-cols-auto">
									<?php
									$query = mysqli_query($koneksi, "SELECT * FROM `pesanan_operasi` WHERE id_toko='$id_toko' AND bayar='1' AND ket='1' AND id_pemesanan>0 
									...
									while ($hasil = mysqli_fetch_assoc($query)) {
										...
										if ($hasil['bayar'] == "0") {
											echo '
												<div class="col mt-2">
													<a href="riwayat-pesanan-operasi.php?id_pemesanan=' . $hasil['id_pemesanan'] . '">
											...
											echo '
												<div class="col mt-2">
													<a href="riwayat-pesanan-operasi.php?id_pemesanan=' . $hasil['id_pemesanan'] . '" class"">
														<div class="card border-0 shadow" style="text-align: center;" id="btn-awal">
															<div class="card-body"">
