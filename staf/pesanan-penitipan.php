				...
				<ul class="navbar-nav">
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="doctoRs">
							...
							<li>
								<a class="dropdown-item active-page" href="pesanan-penitipan.php">Penitipan</a>
							</li>
							<li>
									...
									<table border="0" width="100%" class="bg-light rounded">
										...
										<tr>
											<td>
													...
													<tbody>
														...
														?>
															...
															<div class="modal fade" id="hapusModal<?= $id_dokumentasi ?>" tabindex="-1" aria-labelledby="hapusModalLabel" aria-hidden="true">
																<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
																	<div class="modal-content">
																		<form action="pesanan-penitipan-post.php" method="post">
																			<div class="modal-header">
												...
												<?php
												// $queryDokumentasi = mysqli_query($koneksi, "SELECT * FROM dokumentasi WHERE id_pilihan_pesanan='1' AND id_pesanan='$id_pesanan_penitipan' ");
								...
								<div class="row row-cols-auto">
									...
									while ($hasil = mysqli_fetch_assoc($query)) {
										...
										if ($hasil['bayar'] == "0") {
											echo '
												<div class="col mt-2">
													<a href="pesanan-penitipan.php?id_pesanan_penitipan=' . $hasil['id_pesanan_penitipan'] . '">
											...
											echo '
												<div class="col mt-2">
													<a href="pesanan-penitipan.php?id_pesanan_penitipan=' . $hasil['id_pesanan_penitipan'] . '" class"">
														<div class="card border-0 shadow" style="text-align: center;" id="btn-awal">
															<div class="card-body"">
