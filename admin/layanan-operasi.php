				...
				<ul class="navbar-nav">
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="doctoRs">
							...
							<li>
								<a class="dropdown-item active-page" href="layanan-operasi.php">Operasi</a>
							</li>
							<li>
						...
						<div class="modal fade" id="tambahData" tabindex="-1" aria-labelledby="tambahDataLabel" aria-hidden="true">
							<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
								<div class="modal-content">
									<form action="layanan-operasi-post.php" method="post" enctype="multipart/form-data">
										...
										<div class="modal-body">
											...
											<div class="mb-3">
												...
												<input type="text" class="form-control" id="jenis_operasi" name="jenis_operasi">
											</div>
											<div class="mb-3">
												<label for="harga" class="form-label">Harga operasi</label>
												<input type="number" class="form-control" id="harga" name="harga">
											</div>
										</div>
										<div class="modal-footer">
											<button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
											<button type="submit" id="tambah_operasi" name="tambah_operasi" class="btn btn-primary">Simpan</button>
										</div>
									</form>
								</div>
							</div>
						...
						<div class="table-container">
							<div class="table-responsive">
								<table class="table m-0">
									...
									<tbody>
										<?php
										$queryOperasi = mysqli_query($koneksi, "SELECT * FROM operasi WHERE id_toko='$id_toko' ORDER BY jenis_hewan ASC");
										...
										?>
											<tr>
												...
												<td>
													<a href="" class="mr-2" data-toggle="modal" data-target="#editModal<?= $id_operasi ?>">
														<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
															<path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
															<path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z" />
														</svg>
													</a>
													<a href="" data-toggle="modal" data-target="#hapusModal<?= $id_operasi ?>">
											...
											<div class="modal fade" id="editModal<?= $id_operasi ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
												<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
													<div class="modal-content">
														<form action="layanan-operasi-post.php" method="post" enctype="multipart/form-data">
															<div class="modal-header">
															...
															<div class="modal-body">
																<input type="text" class="form-control" id="id_operasi" name="id_operasi" value="<?= $id_operasi ?>" hidden>
																...
																<div class="mb-3">
																	<label for="jenis_operasi" class="form-label">Jenis operasi</label>
																	<input type="text" class="form-control" id="jenis_operasi" name="jenis_operasi" value="<?= $jenis_operasi ?>">
																</div>
																<div class="mb-3">
															...
															<div class="modal-footer">
																<button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
																<button type="submit" id="edit_operasi" name="edit_operasi" class="btn btn-primary">Simpan</button>
															</div>
														</form>
													</div>
												</div>
											...
											<div class="modal fade" id="hapusModal<?= $id_operasi ?>" tabindex="-1" aria-labelledby="hapusModalLabel" aria-hidden="true">
												<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
													<div class="modal-content">
														<form action="layanan-operasi-post.php" method="post">
															<div class="modal-header">
																<h5 class="modal-title" id="hapusModalLabel"><?= $jenis_operasi ?></h5>
																<button type="button" class="close" data-dismiss="modal" aria-label="Close">
																	<span aria-hidden="true">&times;</span>
																</button>
															</div>
															<div class="modal-body">
																<div class="mb-3">
																	<label for="nama_hewan" class="form-label">Menghapus operasi akan menghapus data yang berhubungan</label>
																	<input type="text" class="form-control" id="id_operasi" name="id_operasi" value="<?= $id_operasi ?>" hidden>
																</div>
															</div>
															<div class="modal-footer">
																<button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
																<button type="submit" id="hapus_operasi" name="hapus_operasi" class="btn btn-primary">Simpan</button>
															</div>
														</form>
													</div>
												</div>
