			...
			<div class="collapse navbar-collapse" id="royalHospitalsNavbar">
				<ul class="navbar-nav">
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="doctoRs">
							<li>
								<a class="dropdown-item active-page" href="riwayat-pesanan-produk.php">Produk</a>
							</li>
							<li>
						...
						<div class="table-container">
							...
							?>
								<div class="row row-cols-auto">
									<?php
									$query = mysqli_query($koneksi, "SELECT * FROM `pesanan_produk` WHERE id_toko='$id_toko' AND ket='1' AND selesai='1' AND id_pemesanan>0 
									...
									while ($hasil = mysqli_fetch_assoc($query)) {
										...
										if ($hasil['bayar'] == "0") {
											echo '
												<div class="col mt-2">
													<a href="riwayat-pesanan-produk.php?id_pemesanan=' . $hasil['id_pemesanan'] . '">
											...
											echo '
												<div class="col mt-2">
													<a href="riwayat-pesanan-produk.php?id_pemesanan=' . $hasil['id_pemesanan'] . '" class"">
														<div class="card border-0 shadow" style="text-align: center;" id="btn-awal">
															<div class="card-body"">
